...
Our analysis focuses on the players that make up each club and is based on these
questions:\

1. Do clubs see more success from purchasing players in the offseason or
fostering talent from their youth acaedmies?\

2. Do a team's player stastics in the FIFA 23 videogame have a relationship with how 
the team performs in the season?\
...
### 1. Transfer and Academy Data\
  ...
  **Use:** Collect data on offseason spending, club value, and academy trasnfers for the
  2022/23 season
  
### 2. Fifa Statistics\
  **Source:** Kaggle - dataset for all players in FIFA 23 \
  **Use:** Gather data on the overalls and market value for each player in La Liga
